...
float g_triangle_y = 0.0f;  // Vertical position of the vertical moving triangle
...
void update()
{
    ...
    g_model_matrix2 = glm::translate(g_model_matrix2, glm::vec3(0.0f, g_triangle_y, 0.0f)); //Transllatng based off position of model matrix 1
